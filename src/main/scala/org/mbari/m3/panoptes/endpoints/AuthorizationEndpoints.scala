...
import org.mbari.m3.panoptes.domain.{Authorization, ErrorMsg}
...
import org.mbari.m3.panoptes.domain.{BadRequest, ErrorMsg, HealthStatus, NotFound, ServerError, StatusMsg, Unauthorized}
